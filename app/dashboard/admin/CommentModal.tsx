    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 sm:mx-0">
        <div className="border-b border-slate-200 px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
          <h2 className="text-xl sm:text-2xl font-bold text-slate-900">Disapproval Comment</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="mt-4 sm:mt-6 flex justify-end">
            <button
              onClick={onClose}
              className="w-full sm:w-auto px-6 py-2.5 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-500/50 font-semibold text-sm sm:text-base"
            >
              Close
            </button>
          </div>
