        ...
        <div className="flex flex-col flex-1 overflow-hidden">
          ...
          <header className="bg-white/80 backdrop-blur-xl border-b border-white/20 shadow-sm z-10">
            <div className="flex items-center justify-between px-6 py-4">
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-indigo-500 to-blue-600 text-white rounded-xl hover:from-indigo-600 hover:to-blue-700 transition-all shadow-lg shadow-indigo-500/50 hover:shadow-xl hover:shadow-indigo-500/50 font-medium"
              >
          ...
          <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
            <div className="max-w-7xl mx-auto">
              {/* Mobile Tabs */}
              <div className="lg:hidden mb-6 flex gap-2 bg-white/80 backdrop-blur-lg rounded-xl p-2 shadow-lg border border-white/20">
                <button
                  onClick={() => setActiveTab("posts")}
              ...
              {/* Content */}
              {activeTab === "posts" && (
                <PostsTable initialPosts={initialPosts} onRefresh={handleRefresh} statusFilter={statusFilter} />
              )}
