...
import { updateUserPost } from "@/app/server/user/posts";
...
export default function EditPostModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await updateUserPost(post.id, {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-3">
            <p className="text-sm text-slate-700">
              <strong>Status:</strong> <span className="font-semibold">{post.status}</span>
            </p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> Status will automatically change to <strong>pending</strong> when you upload an image, or <strong>draft</strong> when you remove it.
            </p>
          </div>
