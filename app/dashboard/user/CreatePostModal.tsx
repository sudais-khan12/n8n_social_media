...
import { createUserPost } from "@/app/server/user/posts";
...
export default function CreatePostModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Create post (status will be "pending" if image provided, "draft" otherwise)
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> New posts are created as <strong>draft</strong>. Status will automatically change to <strong>pending</strong> when you upload an image.
            </p>
          </div>
